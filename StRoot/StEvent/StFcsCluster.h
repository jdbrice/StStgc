/****************************************************************************
 *
 * $Id: StFcsCluster.h,v 1.2 2019/06/21 17:43:22 akio Exp $
 *
...
inline int StFcsCluster::nPhotons() const { return mPhotons.size(); }
...
inline StPtrVecFcsPoint& StFcsCluster::points() { return mPhotons; }
inline const StPtrVecFcsPoint& StFcsCluster::points() const { return mPhotons; }
